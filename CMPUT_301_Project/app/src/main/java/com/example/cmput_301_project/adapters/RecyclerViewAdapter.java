...
import com.example.cmput_301_project.pages.HabitEventHistoryPage;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ItemVH> {
    ...
    public RecyclerViewAdapter(Activity fm, boolean delMode) {
        ...
        for (Account ua: firestoreHandler.getAccountData().values()) {
            if (ua.getId().equals(userId)) {
                userAccount = ua;
            }
        }
        if (!userAccount.getId().equals(FirestoreHandler.create().getActiveUserId())) {
    ...
    public void onBindViewHolder(RecyclerViewAdapter.ItemVH holder, int position) {
        ...
        if (!userId.equals(FirestoreHandler.create().getActiveUserId())) {
        ...
        public ItemVH(View itemView) {
            ...
            editButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    HabitFragmentHelper alertDialog = new HabitFragmentHelper().newInstance(habit);
            ...
            historyButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    FragmentActivity activity = (FragmentActivity)(context);
                    Intent switchActivityIntent = new Intent(activity, HabitEventHistoryPage.class);
                    Habit habit = habitList.get(getAdapterPosition());
