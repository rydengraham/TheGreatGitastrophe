...
import com.example.cmput_301_project.HabitLocation;
...
public class LocationPage extends AppCompatActivity implements OnMapReadyCallback {
                ...
                addLocation.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        if(userLocationAvailable) {
                            ...
                            Toast.makeText(LocationPage.this,
    ...
    private void setUpMap(LatLng newLatLng){
        ...
        mapFragment.getMapAsync(LocationPage.this::onMapReady);
        Bundle extras = getIntent().getExtras();
        String eventId = extras.getString("eventId");
        String habitName = extras.getString("habitName");
        userAccount = FirestoreHandler.create().getActiveUserAccount();
    ...
    private void setAddress(Location location) {
        ...
        try {
            ...
            resultMessage = LocationPage.this
